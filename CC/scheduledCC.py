...
def plot_final_graph(addition="", third=True, ylim_loss=4, ylim_error=1):
    history_no_clipping = pickle.load(open(addition + '_trainHistoryDict', "rb"))
    history_05 = pickle.load(open(addition + '_trainHistoryDict_clip_05', "rb"))
    if third:
        history_1 = pickle.load(open(addition + '_trainHistoryDict_clip_1', "rb"))
...
history = functions.run_training(model, model_type, x_train, y_train, x_test, y_test,
                       prefix + 'trainHistoryDict_clip_05', steps_per_epoch=100, epochs=650,
                       batch_size=100,
                       callbacks=callbacks)
...
history = functions.run_training(model, model_type, x_train, y_train, x_test, y_test,
                       prefix + 'trainHistoryDict_clip_1', steps_per_epoch=100, epochs=650,
                       batch_size=100,
                       callbacks=callbacks)
